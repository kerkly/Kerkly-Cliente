package com.example.kerklyv5.DescarPdf
...
class PDF(nombreC: String, direccionC: String, folio:Int, telefono: String, correo: String, problema:String, total: Double) {
    var nombre = nombreC
    ...
    fun generarPdf() {
        ...
        try {
            ...
            documento.add(
                Paragraph("En el presente documento se le hace llegar la cotización" +
